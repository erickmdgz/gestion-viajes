...
*This is an English reference translation. The canonical governance file that Claude Code auto-loads is the Spanish `/CLAUDE.md` at the repo root.*
...
The full operational detail is in the sections below and in the referenced document:
...
- The parent documentation guide is `guia_documentacion_desarrollo_saludable_ia.md`.
